...
public class AudioChannel extends Thread {
    ...
    private ArrayList<MessageMic> queue = new ArrayList<MessageMic>(); //queue of messages to be played
    ...
    public void addToQueue(MessageMic m) { //adds a message to the play queue
        queue.add(m);
    }
